...
def load_documents():
    ...
    print(f"Loaded {len(documents)} rule document(s): {[d['prof'] for d in documents]}")
    return documents


def chunk_document(text, prof_name):
    """
    ...
    Strategy: character-based sliding window with overlap.
      - chunk_size = 200 characters: long enough to carry the semantic
